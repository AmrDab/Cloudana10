...
import { StakePanel } from "@/components/providers/StakePanel";
    ...
    >
      ...
      {!isLoading && provider && (
        <>
          ...
          <h2 className="mb-4 text-lg font-semibold tracking-tight">Security & Staking</h2>
          <div className="mb-6">
            <StakePanel
              stakingManagerAddress={CONTRACT_ADDRESSES.contracts.StakingManager as Address}
              providerAddress={provider.owner as Address}
            />
          </div>
