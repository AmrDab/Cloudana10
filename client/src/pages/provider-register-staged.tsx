...
export type ProviderRegisterStagedProps = {
  /** When set, last step "Create Provider" calls this instead of navigating; used when guide is embedded on provider page */
  onGuideComplete?: () => void;
  /** When set, show "Skip guide" that calls this */
  onSkip?: () => void;
};

export default function ProviderRegisterStaged(props: ProviderRegisterStagedProps = {}) {
  const { onGuideComplete, onSkip } = props;
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-4">
      <div className="mb-8 flex items-start justify-between gap-4">
        ...
        {onSkip && (
          <Button variant="ghost" size="sm" className="text-muted-foreground shrink-0" onClick={onSkip}>
            Skip guide
          </Button>
        )}
      </div>
