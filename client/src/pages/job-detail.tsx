...
import { POUWStatus } from "@/components/providers/POUWStatus";
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="glass-card border-white/10">
            ...
            <CardContent className="space-y-6">
              ...
              {/* POUW Certificate & Fraud Verification */}
              <div>
                <Label className="text-sm text-muted-foreground mb-2 block">Proof of Useful Work</Label>
                <POUWStatus
                  jobId={`0x${workloadId.toString(16).padStart(64, "0")}` as Hex}
                  isChallenger={false}
                />
              </div>
